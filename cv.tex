...
\raggedleft\raggedright\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{Tools}: \href{https://git-scm.com}{Git}, \href{https://www.mongodb.com}{MongoDB}, \href{https://www.docker.com}{Docker}, \href{https://terraform.io}{Terraform}
	...
	\cventry{2023}{President}{}{}{}{\begin{itemize}
		...
		% \item Added to the \href{https://monsec.io}{club's website} a footer with social media links and a \href{https://en.wikipedia.org/wiki/Tree_(data_structure)}{tree}-like content organisation system.
	...
	\subsection{Research}
	\hypertarget{FIT3144}{
		\cventry{2023 Semester 1 \& 2}{Research Assistant}{Monash University's \href{https://handbook.monash.edu/2023/units/FIT3144}{FIT3144 unit}}{Melbourne}{}{
			\begin{itemize}
				\item Extended a browser-based tool \href{https://arxiv.org/abs/2302.06277}{(Wagner et al., 2023)} used for building evolutionary algorithms in educational settings. Supervised by \href{https://research.monash.edu/en/persons/markus-wagner}{Markus Wagner}.
			\end{itemize}
		}
	}
	\hypertarget{FIT2082}{
		\cventry{2021 Semester 2}{Research Assistant}{Monash University's \href{https://handbook.monash.edu/2021/units/FIT2082}{FIT2082 unit}}{Melbourne}{}{
			\begin{itemize}
				...
				\item Built with C/C++ and \href{https://python.org}{Python} for Linux-based platforms. Supervised by \href{https://research.monash.edu/en/persons/daniel-harabor}{Daniel Harabor} and \href{https://research.monash.edu/en/persons/mor-vered}{Mor Vered}.
				% \begin{itemize}
	...
	\cventry{2021 Q3 --- Q4}{Freelance Programmer}{Contract}{Melbourne}{}{\begin{itemize}
		\item Implemented a custom fault-tolerant file back-up system that enables the continuation of file transferring from a variably-approximate point in time before the back-up disruption.
	\end{itemize}}

	\section{Open-Source Projects}\label{sec:open-source}
	\hypertarget{raker}{
		\cventry{since May 2022}{\texttt{raker}}{\ghurl{AppleGamer22/raker}}{Go, Docker, MongoDB}{}{
			\begin{itemize}
	...
	\hypertarget{stalk}{
		\cventry{since May 2022}{\texttt{stalk}}{\ghurl{AppleGamer22/stalk}}{Go, Linux}{}{
			\begin{itemize}
	...
	\hypertarget{cocainate}{
		\cventry{since January 2022}{\texttt{cocainate}}{\ghurl{AppleGamer22/cocainate}}{Go, Linux}{}{
			\begin{itemize}
	...
	% }
	\hypertarget{sp}{
		\cventry{2020 --- 2021}{\texttt{sp}}{\ghurl{AppleGamer22/sp}}{Kotlin}{}{
			\begin{itemize}
	...
	% \hypertarget{scr}{
	% 	\cventry{2019 --- 2022}{scr-web}{\ghurl{AppleGamer22/scr-web}}{TypeScript, Angular, Docker, MongoDB}{}{
	% 		\begin{itemize}

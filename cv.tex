...
\raggedleft\raggedright\begin{document}
	...
	\cvlanguage{\href{https://go.dev}{Go}}{Expert}{server-side and command-line interfaces (CLIs)}
	\cvlanguage{\href{https://typescriptlang.org}{TypeScript}}{Expert}{full-stack}
	\cvlanguage{JavaScript}{Expert}{client-side on web browsers}
	\cvlanguage{\href{https://python.org}{Python}}{Proficient}{data analysis and \hyperref[sec:research]{research}}
	\cvlanguage{\href{https://kotlinlang.org}{Kotlin}/Java}{Intermediate}{Minecraft plugins}
	\cvlanguage{C/C++}{Intermediate}{\hyperref[sec:research]{research}}
	\subsection{\textbf{Document Markup Languages}}
	\cvlanguage{HTML/CSS}{Proficient}{client-side UI on web browsers}
	\cvlanguage{\TeX/\LaTeX}{Proficient}{PDF document typesetting}
	\cvlanguage{Markdown}{Expert}{technical documentation and communication}
	% \subsection{Natural Languages}
	% \cvlanguage{English}{full professional proficiency}{}
	% \cvlanguage{Hebrew}{native or bilingual proficiency}{}
	\subsection{\textbf{Tools}}
	\cvlanguage{\href{https://git-scm.com}{Git}}{Expert}{source code version control (see \hyperref[sec:open-source]{open-source projects} for examples)}
	\cvlanguage{\href{https://github.com}{GitHub}/\href{https://gitlab.com}{GitLab}}{Expert}{collaboration and CI/CD}
	\cvlanguage{\href{https://www.mongodb.com}{MongoDB}}{Proficient}{document non-relational database}
	\cvlanguage{SQL}{Intermediate}{relational database querying}
	\cvlanguage{\href{https://www.docker.com}{Docker}}{Proficient}{container-style packaging}
	\cvlanguage{\href{https://kubernetes.io}{Kubernetes}}{Intermediate}{container orchestration}
	\cvlanguage{\href{https://vagrantup.com}{Vagrant}}{Proficient}{virtual machine (VM) management}
	\subsection{\textbf{Other}}
	\cvlistitem{\textbf{Platforms}: Linux, Cloud Native, web servers/browsers, macOS, Windows}
	\cvlistitem{\textbf{Soft Skills}: technical writing, presenting/public speaking, research, troubleshooting/debugging, explaining, collaboration/teamwork}

...
\raggedleft\raggedright\begin{document}
	...
	\begin{itemize}
		...
		% [ctftime-discord-bot](https://github.com/monsec/ctftime-discord-bot) is a discord bot I made for the [MonSec](https://monsec.io) Discord server, that fetches statistics about competing teams from [CTFtime]().

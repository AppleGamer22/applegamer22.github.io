...
\title{Software/Security Engineer}
...
\raggedleft\raggedright\begin{document}
	...
	\begin{itemize}
		\item \textbf{Programming Languages}: \textbf{Go}, JavaScript/TypeScript, \textbf{Python}, Kotlin/Java, C/C++,C\#
		\item \textbf{Tools}: \textbf{Git} (with GitHub/GitLab), MongoDB, \textbf{Docker}, \textbf{Terraform}, gRPC/Protocol Buffers, \href{https://gohugo.io}{Hugo}, \href{https://nixos.org}{NixOS}
	...
	\section{Experience}
	\cventry{since June 2024}{Associate Software Engineer}{Altera Digital Health}{Melbourne (remote)}{.NET, Angular, MSSQL}{\begin{itemize}

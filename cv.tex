...
\raggedleft\raggedright\begin{document}
	...
	\cvlanguage{\href{https://go.dev}{Go}}{}{server-side and command-line interfaces (CLIs)}
	\cvlanguage{\href{https://typescriptlang.org}{TypeScript}}{}{full-stack}
	\cvlanguage{JavaScript}{}{client-side on web browsers}
	\cvlanguage{\href{https://python.org}{Python}}{}{data analysis and \hyperref[sec:research]{research}}
	\cvlanguage{\href{https://kotlinlang.org}{Kotlin}/Java}{}{Minecraft plugins}
	\cvlanguage{C/C++}{}{\hyperref[sec:research]{research}}
	\subsection{Document Markup Languages}
	\cvlanguage{HTML/CSS}{}{client-side on web browsers}
	\cvlanguage{\TeX/\LaTeX}{}{PDF document typesetting}
	\cvlanguage{Markdown}{}{technical documentation and communication}
	...
	\subsection{Tools}
	\cvlanguage{\href{https://git-scm.com}{Git}}{}{source code version control}
	\cvlanguage{\href{https://github.com}{GitHub}/\href{https://gitlab.com}{GitLab}}{}{collaboration and CI/CD}
	\cvlanguage{\href{https://www.mongodb.com}{MongoDB}}{}{document non-relational database}
	\cvlanguage{SQL}{}{relational database querying}
	\cvlanguage{\href{https://www.docker.com}{Docker}}{}{container-style packaging}
	\cvlanguage{\href{https://kubernetes.io}{Kubernetes}}{}{container orchestration}
	\cvlanguage{\href{https://vagrantup.com}{Vagrant}}{}{virtual machine (VM) management}
	\subsection{Other}

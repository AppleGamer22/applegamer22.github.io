...
\raggedleft\raggedright\begin{document}
	...
	\section{Skills}
	\subsection{\textbf{Computer Programming Languages}}
	\cvitemwithcomment{\href{https://go.dev}{Go}}{Expert}{server-side and command-line interfaces (CLIs)}
	\cvitemwithcomment{\href{https://typescriptlang.org}{TypeScript}}{Expert}{full-stack}
	\cvitemwithcomment{JavaScript}{Expert}{client-side on web browsers}
	\cvitemwithcomment{\href{https://python.org}{Python}}{Proficient}{data analysis and \hyperref[sec:research]{research}}
	\cvitemwithcomment{\href{https://kotlinlang.org}{Kotlin}/Java}{Intermediate}{Minecraft plugins}
	\cvitemwithcomment{C/C++}{Intermediate}{\hyperref[sec:research]{research}}
	\subsection{\textbf{Document Markup Languages}}
	\cvitemwithcomment{HTML/CSS}{Proficient}{client-side UI on web browsers}
	\cvitemwithcomment{\TeX/\LaTeX}{Proficient}{PDF document typesetting}
	\cvitemwithcomment{Markdown}{Expert}{technical documentation and communication}
	...
	\cvitemwithcomment{\href{https://git-scm.com}{Git}}{Expert}{source code version control (see \hyperref[sec:open-source]{open-source projects} for examples)}
	\cvitemwithcomment{\href{https://github.com}{GitHub}/\href{https://gitlab.com}{GitLab}}{Expert}{collaboration and CI/CD}
	\cvitemwithcomment{\href{https://www.mongodb.com}{MongoDB}}{Proficient}{document non-relational database}
	\cvitemwithcomment{SQL}{Intermediate}{relational database querying}
	\cvitemwithcomment{\href{https://www.docker.com}{Docker}}{Proficient}{container-style packaging}
	\cvitemwithcomment{\href{https://kubernetes.io}{Kubernetes}}{Intermediate}{container orchestration}
	\cvitemwithcomment{\href{https://vagrantup.com}{Vagrant}}{Proficient}{virtual machine (VM) management}
	\subsection{\textbf{Other}}
	\cvlistitem{\textbf{Platforms}: Linux, Cloud Native, web servers/browsers, macOS, Windows}
	\cvlistitem{\textbf{Soft Skills}: technical writing, critical/analytical thinking, presenting/public speaking, research, troubleshooting/debugging, explaining, collaboration/teamwork}

	\section{Projects}
	\subsection{\textbf{Open-Source}}\label{sec:open-source}
	...
	\subsection{\textbf{Research}}\label{sec:research}

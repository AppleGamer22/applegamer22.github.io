...
\raggedleft\raggedright\begin{document}
	...
	\cventry{2021 Q3 --- Q4}{Software Engineer}{Contract}{Melbourne}{\hyperref[sec:skills]{Go, Windows \& test-driven development}}{\begin{itemize}
		\item Implemented a custom fault-tolerant file back-up system that enables the continuation of file transferring from a variably-approximate point in time before the disruption. Available at \ghurl{AppleGamer22/rb}.
	\end{itemize}}

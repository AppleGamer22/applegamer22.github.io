...
\raggedleft\raggedright\begin{document}
	...
	\end{itemize}}
	\cventry{}{\texttt{raker}}{\url{https://github.com/AppleGamer22/raker}}{}{}{\begin{itemize}
	...
	\cventry{December 2021}{CTFtime Discord Bot}{\url{https://github.com/monsec/ctftime-discord-bot}}{}{}{\begin{itemize}
		\item A discord bot I made for the \href{https://monsec.io/contact/}{MonSec} Discord server, that fetches statistics about competing teams from \href{https://ctftime.org}{CTFtime}, and displays them in the Discord interface.
	\end{itemize}}
	\cventry{June 2020 \\ January 2021}{sp}{\url{https://github.com/AppleGamer22/sp}}{}{}{\begin{itemize}
		\item My first attempt at building a Minecraft server plugin. This plugin adds the requirement that the player supplies the password (via a server command) before proper server interaction is allowed, and as long as the password isn't provided, the currently-unauthorized player is blinded and immobile.
	\end{itemize}}
	...
	\cventry{June 2021 \\ December 2021}{}{}{}{}{\begin{itemize}

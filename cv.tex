...
\raggedleft\raggedright\begin{document}
	\maketitle
	\section{Education}
	\cventry{2020 --- 2023}{Bachelor of Computer Science}{\href{https://www.monash.edu/it}{Monash University}}{Clayton VIC}{}{}
	% \cventry{2017 --- 2019}{SACE}{\href{https://asms.sa.edu.au}{Australian Science \& Mathematics School} (ASMS)}{Bedford Park SA}{}{}

	\section{Skills}\label{sec:skills}
	\begin{itemize}
		\item \textbf{Programming Languages}: \textbf{Go}, JavaScript/\textbf{TypeScript}, Python, Kotlin/Java, C/C++,C\#
		\item \textbf{Tools}: \textbf{Git}, Postgres, \textbf{Docker}, \textbf{Terraform}, gRPC/Protocol Buffers, \href{https://nixos.org}{NixOS}
		...
		% \item \textbf{Security Analysis}: reverse-engineering (Ghidra), network analysis (Wireshark), Burp Suite, entry analysis (\texttt{nmap}, \texttt{gobuster}, \texttt{sqlmap}), credential brute-forcing (\texttt{hydra}, \texttt{john}, \texttt{hashcat})
	...
	\section{Experience}
	\cventry{Q2 2026}{Software Engineer}{Altera Digital Health}{}{C\#.NET, Angular, MSSQL, GitHub Copilot}{}
	\cventry{Q3 2024---Q2 2026}{Associate Software Engineer}{Altera Digital Health}{}{C\#.NET, Angular, MSSQL, GitHub Copilot}{\begin{itemize}
		\item Contributed enhancements and fixes to existing products.
		\item Co-lead PoC and custom implementation projects based on requirements set by APAC clients.
		\item Designed CI/CI pipelines for building and signing releases.
		\item Used coding agents to develop a PoC for a product rewrite, which was near feature-complete in 1 month.
	\end{itemize}}
	\subsection{\href{https://monsec.io/contact_team/\#2023-team}{Monash Cyber Security Club} (MonSec)}
	\cventry{2023}{President}{}{}{\hyperref[sec:skills]{Terraform, Azure, Git}}{\begin{itemize}
	...
	\cventry{2022 Q1---Q2}{Secretary}{}{}{\hyperref[sec:skills]{Python, Git}}{\begin{itemize}
		...
		\item Wrote a guide on the \href{https://monsec.io/posts/resources/}{resources page of the club's website} on how to easily install and set-up a \href{https://www.kali.org}{Kali Linux} virtual machine.
	\end{itemize}}
	...
	\cventry{2021 Q3---Q4}{Software Engineer}{Contract}{Melbourne}{\hyperref[sec:skills]{Go}}{
	...
	\hypertarget{raker}{
		\cventry{since May 2022}{\texttt{raker}}{\ghurl{AppleGamer22/raker}}{\hyperref[sec:skills]{Go, React, Docker, Postgres, gRPC}}{}{
			A social media scraper that is interfaced via a React web interface, and is managed by a \href{https://connectrpc.com}{Connect RPC} API and a Postgres SQL database. I presented an early iteration of project at \href{https://www.meetup.com/golang-mel/events/293777783/}{Melbourne's Go meet-up}.
		}
	}
	\hypertarget{stalk}{
	...
	% }
	\hypertarget{scr}{
		\cventry{2019 --- 2022}{scr-web}{\ghurl{AppleGamer22/scr-web}}{\hyperref[sec:skills]{TypeScript, Angular, Puppeteer, Docker \& MongoDB}}{}{
	...
	\hypertarget{IaC}{
		\cventry{since 2025}{IaC}{\ghurl{AppleGamer22/IaC}}{\hyperref[sec:skills]{Terraform, Tailscale, Azure}}{}{
			My infrastructure-as-code experiments, including a self-managed VPN set-up (more details in my \href{https://applegamer22.github.io/posts/opentofu/tailscale/}{blog}).
		}
	}
	\end{document}